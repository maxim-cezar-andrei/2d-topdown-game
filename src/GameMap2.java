// GameMap2.java actualizat cu integrare completă a clasei Nyx
...
class GameMap2 extends JPanel implements KeyListener {
    ...
    public GameMap2(JFrame parentFrame) {
        ...
        pauseMenu = new PauseMenuPanel(
                ...
                () -> { JOptionPane.showMessageDialog(GameMap2.this, "Load not implemented yet."); },
                () -> { JOptionPane.showMessageDialog(GameMap2.this, "Options coming soon!"); },
                () -> { System.exit(0); }
        );
